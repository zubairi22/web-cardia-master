...
import { A as ApplicationLogo } from "./ApplicationLogo-d8892447.mjs";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        href: _ctx.route("hospital.index"),
        active: _ctx.route().current("hospital.index")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Hospital `);
