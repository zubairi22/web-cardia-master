...
import { _ as _sfc_main$2 } from "./GuestLayout-023fb72d.mjs";
...
import { _ as _sfc_main$6 } from "./LinkButton-91889de0.mjs";
      ...
      _push(ssrRenderComponent(_sfc_main$2, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span class="ml-2 text-sm text-gray-600"${_scopeId}>Ingat saya</span></label></div><div class="flex items-center justify-end mt-4"${_scopeId}>`);
              ...
              createVNode("form", {
                ...
                createVNode("div", { class: "block mt-4" }, [
                  createVNode("label", { class: "flex items-center" }, [
                    ...
                    createVNode("span", { class: "ml-2 text-sm text-gray-600" }, "Ingat saya")
                  ])
                ]),
